...
public class ReviewController {
    ...
    @GetMapping("buyer/food/count/{foodId}")
    public ResponseEntity<?> countStoreReviewsByFood(@PathVariable Long foodId) {
        return ResponseEntity.ok(reviewService.getFoodDetailCount(foodId));
    }
}
